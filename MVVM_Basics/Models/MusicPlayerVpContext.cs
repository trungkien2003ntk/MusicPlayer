...
public partial class MusicPlayerVpContext : DbContext
{
    ...
    public virtual DbSet<FollowingArtist> FollowingArtists { get; set; }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.UsersId, e.AlbumId }).HasName("PK__added_al__D1A9CC9063635206");
            ...
            entity.HasOne(d => d.Album).WithMany(p => p.AddedAlbums)
                .HasForeignKey(d => d.AlbumId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__added_alb__album__46E78A0C");

            entity.HasOne(d => d.Users).WithMany(p => p.AddedAlbums)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__album__3213E83FD83CFB97");
        ...
        {
            entity.HasKey(e => new { e.AlbumId, e.ArtistId }).HasName("PK__album_ar__B62CD9B2F2CD0A01");
        ...
        {
            entity.HasKey(e => new { e.SongId, e.AlbumId }).HasName("PK__album_so__9E3BB3C7C5ACAC30");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__artist__3213E83FD2D31583");
        ...
        {
            entity.HasKey(e => new { e.UsersId, e.ArtistId }).HasName("PK__followin__EC6AD54B29B8D139");
            ...
            entity.HasOne(d => d.Artist).WithMany(p => p.FollowingArtists)
                .HasForeignKey(d => d.ArtistId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__following__artis__3F466844");

            entity.HasOne(d => d.Users).WithMany(p => p.FollowingArtists)
                .HasForeignKey(d => d.UsersId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.UsersId, e.SongId }).HasName("PK__liked_so__30F48BAAA0949733");
            ...
            entity.HasOne(d => d.Users).WithMany(p => p.LikedSongs)
                .HasForeignKey(d => d.UsersId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__playlist__3213E83F0B0E4A4B");
        ...
        {
            entity.HasKey(e => new { e.SongId, e.PlaylistId }).HasName("PK__playlist__BA8C6F5DA1AA1FE5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__song__3213E83FEA030D34");
        ...
        {
            entity.HasKey(e => new { e.SongId, e.ArtistId }).HasName("PK__song_art__A3F8AA1C9233D7EA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__users__3213E83FB3283A95");
